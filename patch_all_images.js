...
async function patch() {
  ...
  }).in('status', ['active', 'paused', 'completed', 'draft']); // Update ALL campaigns to ensure test suite renders
  console.log("Patched All Images to Supabase Allowed Bucket:", error ? error : 'Success');
}
patch();
